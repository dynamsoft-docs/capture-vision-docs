...
**Parent object:** [AssembleTextLinesStage]({{ site.dcvb_parameters_reference }}label-recognizer-task-settings/stage-assemble-text-lines.html)
...
> - To use it, embed this parameter within a [AssembleTextLinesStage]({{ site.dcvb_parameters_reference }}label-recognizer-task-settings/stage-assemble-text-lines.html) object.
