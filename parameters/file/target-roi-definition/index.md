...
| Parameter Name | Description |
| -------------------------------- | ----------- |
| [`ReferenceTargetROIDefNameArray`]({{site.parameter_reference}}target-roi-def/location.html#referencetargetroidefnamearray) | Reference the atomic object generated by other `TargetROIDef` objects by specifying its name. This parameter will intersect with the `AtomicResultTypeArray` parameter to determine the final referenced `TargetROIDef` objects. |
| [`AtomicResultTypeArray`]({{site.parameter_reference}}target-roi-def/location.html#atomicresulttypearray) | Set atomic result types that can be used as reference objects. This parameter will intersect with the `ReferenceTargetROIDefNameArray` parameter to determine the final referenced `TargetROIDef` objects. |
| [`BarcodeFilteringCondition`]({{site.parameter_reference}}target-roi-def/location.html#barcodefilteringcondition) | Set barcode conditions that can be used as reference objects. |
| [`FrameFilteringCondition`]({{site.parameter_reference}}target-roi-def/location.html#framefilteringcondition) | Set frame conditions that can be used as reference objects. |
| [`TextLineFilteringCondition`]({{site.parameter_reference}}target-roi-def/location.html#textlinefilteringcondition) | Set text line conditions that can be used as reference objects |
| [`ColourRegionFilteringCondition`]({{site.parameter_reference}}target-roi-def/location.html#colourregionfilteringcondition) | Set colour region conditions that can be used as reference *objects* |
...
| Parameter Name | Description |
| -------------------------------- | ----------- |
| [`ReferenceObjectOriginIndex`]({{site.parameter_reference}}target-roi-def/location.html#referenceobjectoriginindex) | This parameter is used to indicate which point in the quadrilateral of the `ReferenceObject` the origin refers to. |
| [`ReferenceObjectSizeType`]({{site.parameter_reference}}target-roi-def/location.html#referenceobjectsizetype) | This parameter is used to indicate the rule by which the region of the `ReferenceObject` is calculated. |
| [`MeasuredByPercentage`]({{site.parameter_reference}}target-roi-def/location.html#measuredbypercentage) | Set barcode conditions that can be used as reference objects. |
| [`FirstPoint`]({{site.parameter_reference}}target-roi-def/location.html#firstpoint) | The first point of the target region, which defines the offset from the origin. |
| [`SecondPoint`]({{site.parameter_reference}}target-roi-def/location.html#secondpoint) | The second point of the target region, which defines the offset from the origin. |
| [`ThirdPoint`]({{site.parameter_reference}}target-roi-def/location.html#thirdpoint) | The third point of the target region, which defines the offset from the origin. |
| [`FourthPoint`]({{site.parameter_reference}}target-roi-def/location.html#fourthpoint) | The fourth point of the target region, which defines the offset from the origin. |
